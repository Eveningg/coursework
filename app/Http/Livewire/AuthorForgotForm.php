...
class AuthorForgotForm extends Component
{
    ...
    public function ForgotHandler(){
        ...
        $body_message = "We are received a request to reset the Password for <b>ashleydumpleton@gmail.com</b> account associated with ".
        ...
        Mail::send('forgot-email-template', $data, function($message) use ($user){
            $message->from('noreply@example.com','Ashley');
